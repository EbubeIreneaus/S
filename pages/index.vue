   ...
   <div class="main">
        ...
        before:bg-slate-900/50 before:z-0">
            <div class="absolute z-50 top-1/3 left-5 sm:top-1/2 sm:left-40 text-white text-left">
                ...
                <h2 class="text-2xl sm:text-4xl">UNCOVER YOUR OPPORTUNITY</h2>
                <p class="text-violet-300">INVEST WITH US TODAY AND EARN AN EXTRA INCOME.</p>
               <div class="mt-5"> <button_ url="/auth/signin" >Get Started</button_></div>
            </div>
        </div>
