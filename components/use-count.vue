    ...
    const increment = () => {
        if (index <= num) {
           elem.innerHTML = index
            index += 10;
            timeout = setTimeout(increment, 50);
        }
    };
    increment();
...
<template>
    <section id="usage"
        class="relative mt-10 bg-[url('~/assets/img/btc-1.jpg')] bg-cover bg-center before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-slate-950/70">
        <div class="py-5 z-40">
